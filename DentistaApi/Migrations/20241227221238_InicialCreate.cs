        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValorPremiacao = table.Column<double>(type: "double", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Controle = table.Column<string>(type: "varchar(1)", nullable: false, defaultValue: "A"),
                    Observacao = table.Column<string>(type: "longtext", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RegistroPonto_Funcionarios_FuncionarioId",
                        column: x => x.FuncionarioId,
                        principalTable: "Funcionarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegistroPonto_Organizacao_OrganizacaoId",
                        column: x => x.OrganizacaoId,
                        principalTable: "Organizacao",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizacaoId = table.Column<int>(type: "int", nullable: false),
                    FuncionarioId = table.Column<int>(type: "int", nullable: false),
                    RegistroPontoId = table.Column<int>(type: "int", nullable: false),
                    Motivo = table.Column<string>(type: "longtext", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    AvaliadoPor = table.Column<int>(type: "int", nullable: false),
                    DataAvaliacao = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JustificativaPonto", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JustificativaPonto_Organizacao_OrganizacaoId",
                        column: x => x.OrganizacaoId,
                        principalTable: "Organizacao",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JustificativaPonto_RegistroPonto_RegistroPontoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JustificativaPonto_OrganizacaoId",
                table: "JustificativaPonto",
                column: "OrganizacaoId");

            migrationBuilder.CreateIndex(
                name: "IX_JustificativaPonto_RegistroPontoId",
                table: "JustificativaPonto",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistroPonto_OrganizacaoId",
                table: "RegistroPonto",
                column: "OrganizacaoId");
        }
